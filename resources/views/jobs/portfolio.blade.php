...
@section('content')
    <!-- ======= Portfolio Section ======= -->
    <section id="portfolio" class="portfolio mt-space">
        <div class="container" data-aos="fade-up">

            <div class="section-title">
            <h2>Portfolio</h2>
            <p>Check out the Job Portfolio</p>
            </div>
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-12 d-flex justify-content-center">
                    ...
                    <li data-filter=".filter-app">Agriculture</li>
                    <li data-filter=".filter-card">Teaching</li>
                    <li data-filter=".filter-web">Engineering</li>
                    <li data-filter=".filter-web">House Related</li>
                    <li data-filter=".filter-web">Management and Accounting</li>
                    </ul>
                </div>
            </div>
